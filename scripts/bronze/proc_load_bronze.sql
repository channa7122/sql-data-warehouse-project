...
===============================================================================
Purpose:
    This stored procedure loads CSV data into all tables in the 'bronze' schema.
    Key operations include:
    - Truncating the target tables before loading.
    - Using BULK INSERT for efficient data import from CSV files.
...
BEGIN
	...
	BEGIN TRY
		...
		PRINT '================================================';
		PRINT 'Starting Load: Bronze Layer';
		PRINT '================================================';
        ...
        SET @start_time = GETDATE();
		PRINT '>> Clearing Table: bronze.crm_prd_info';
        ...
        SET @start_time = GETDATE();
		PRINT '>> Clearing Table: bronze.crm_sales_details';
		...
		SET @start_time = GETDATE();
		PRINT '>> Clearing Table: bronze.erp_loc_a101';
		...
		SET @start_time = GETDATE();
		PRINT '>> Clearing Table: bronze.erp_cust_az12';
		...
		SET @start_time = GETDATE();
		PRINT '>> Clearing Table: bronze.erp_px_cat_g1v2';
